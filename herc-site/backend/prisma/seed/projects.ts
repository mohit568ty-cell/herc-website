...
const projects = [
  {
    ...
    imageUrl:
      "/assets/gallery/ecology-quadrat-survey-plot-03.jpeg",
    status: "Completed",
  },

  {
    ...
    imageUrl:
      "/assets/gallery/rocky-trail-ascent-01.jpeg",
    status: "Completed",
  },

  {
    ...
    imageUrl:
      "/assets/gallery/ecology-quadrat-wildflowers-01.jpeg",
    status: "Completed",
  },

  {
    ...
    imageUrl:
      "/assets/gallery/ecology-quadrat-survey-plot-01.jpeg",
    status: "Completed",
  },

  {
    ...
    imageUrl:
      "/assets/gallery/field-team-discussion-meadow-01.jpeg",
    status: "Completed",
  },

  {
    ...
    imageUrl:
      "/assets/gallery/forest-trail-trekking-02.jpeg",
    status: "Completed",
  },

  {
    ...
    imageUrl:
      "/assets/gallery/gps-device-elevation-reading-01.jpeg",
    status: "Completed",
  },

  {
    title:
      "ISRO-GBP: Global Climate Change Studies in High Altitude Himalaya",
    slug: "isro-gbp-climate-study",
    description:
      "Supported climate change studies through field surveys, laboratory work and documentation.",
    imageUrl:
      "/assets/gallery/satellite-map-monitoring-stations-01.jpeg",
    status: "Completed",
  },

  {
    ...
    imageUrl:
      "/assets/gallery/researcher-glacier-icecave-01.jpeg",
    status: "Completed",
  },

  {
    title:
      "Participatory Water Management Plan for Mid-Altitude Himalayan Villages",
    ...
    imageUrl:
      "/assets/gallery/village-houses-mountainside-01.jpeg",
    status: "Completed",
  },

  {
    ...
    imageUrl:
      "/assets/gallery/glacier-moraine-valley-01.jpeg",
    status: "Completed",
  },

  {
    ...
    imageUrl:
      "/assets/gallery/glacier-terminus-bhagirathi-origin-01.jpeg",
    status: "Completed",
  },

  {
    ...
    description:
      "Providing project implementation, documentation, administrative coordination and institutional support.",
    imageUrl:
      "/assets/gallery/nmhs-conference-session-newdelhi-01.jpeg",
    status: "Ongoing",
  },
];
